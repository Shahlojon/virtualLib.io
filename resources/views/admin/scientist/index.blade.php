...
<div class="content-body">
    ...
    <div class="row">
        <div class="col-12 mb-30">
            <a href="/admin/scientist/create" class="button button-my float-right"><span><i class="ti-plus"></i>Добавить</span></a>
        </div>
                        ...
                        <tbody>
                            @foreach($data as $item)
                                <tr>
                                    ...
                                    <td><strong>{!! mb_substr($item->name, 0, 250) !!}</strong></td>
                                    <td width="70">
                                        @if($item->isActive)
                                    ...
                                    <td width="170" class="text-center act"  style="vertical-align: middle">
                                        <a href="/admin/scientist/edit/{{$item->id}}">
                                        <span  class="ti-pencil edit-item mr-10"></span>
                                        </a>
                                        <a href="/admin/scientist/destroy/{{$item->id}}">
