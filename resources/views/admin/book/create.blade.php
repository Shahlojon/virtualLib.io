    ...
    <!-- Page Heading Start -->
        <div class="col-12 col-lg-auto mb-20">
            <div class="page-heading">
                <h3 class="title">Книги создания</h3>
            </div>
                            ...
                            <div class="row mbn-20">
                                ...
                                <div class="col-12 mb-20">
                                    ...
                                    <div class="row mbn-15">
                                        ...
                                        <div class="col-12 mb-15">
                                        <input  required name="isbn" type="text" class="form-control" placeholder="ISBN">
                                        </div>  

                                        <div class="col-12 mb-15">
                                        <input  name="yearOfIssue" type="date" class="form-control" placeholder="Год выпуска">
                                        </div>
                                                                    
                                        <div class="col-12 mb-15">
                                        <input  name="pageCount" type="number" class="form-control" placeholder="Страницы">
                                        </div> 
                                        ...
                                        <div class="col-12 mb-15">
                                        <input  name="file" type="file" class="form-control" placeholder="Файл">
                                        </div> 
