                            ...
                            <div class="row">
                                <div class="col-md-4 col-sm-4 col-xs-12 col-custom" style="padding-bottom:25px ;">
                                    <div class="authorimage">
                                        <img src="/public/uploads/{{$book->image}}" >
                                    </div>
                                </div>
                                <div class="col-md-8 ">
                                    <div class="left-content ">
                                        ...
                                        <div class="col-12 d-flex">
                                            <div class="col-4 fw-700 mr-10">Год выпуска : </div>
                                            <div class="col-8">{{$book->yearOfIssue}}  год</div>
                                        </div>
                                        <div class="col-12 d-flex">
        ...
        <section class="popular-places pt-0 mt-30" id="popular">
            <div class="col-12 description-book" >
                <div class="row">
                    ...
                    <p class="mt-10">{!!html_entity_decode($book->description)!!}</p>
